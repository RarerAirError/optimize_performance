...
export class RedisAPIClientJSON {
    ...
    HMGet(request) {
        const data = HMGetRequest.toJSON(request);
        const promise = this.rpc.request('devvit.plugin.redis.RedisAPI', 'HMGet', 'application/json', data);
...
export class RedisAPIClientProtobuf {
    ...
    HMGet(request) {
        ...
        const promise = this.rpc.request('devvit.plugin.redis.RedisAPI', 'HMGet', 'application/protobuf', data);
