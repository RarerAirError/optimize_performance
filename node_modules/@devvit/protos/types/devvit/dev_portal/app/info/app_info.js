...
function createBaseAppInfo() {
    return {
        ...
        capabilities: [],
        isDisabled: false,
        minSubredditSizeRestrictionEnabled: false,
    };
}
export const AppInfo = {
    ...
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.minSubredditSizeRestrictionEnabled !== false) {
            writer.uint32(160).bool(message.minSubredditSizeRestrictionEnabled);
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromPartial(object) {
        ...
        message.minSubredditSizeRestrictionEnabled = object.minSubredditSizeRestrictionEnabled ?? false;
        return message;
    },
};
...
function createBaseAppStats() {
    return { installCount: 0, versionsCount: 0 };
}
export const AppStats = {
    ...
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.versionsCount !== 0) {
            writer.uint32(16).int32(message.versionsCount);
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    message.versionsCount = reader.int32();
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return {
            installCount: isSet(object.installCount) ? globalThis.Number(object.installCount) : 0,
            versionsCount: isSet(object.versionsCount) ? globalThis.Number(object.versionsCount) : 0,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.versionsCount !== 0) {
            obj.versionsCount = Math.round(message.versionsCount);
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.versionsCount = object.versionsCount ?? 0;
        return message;
    },
};
